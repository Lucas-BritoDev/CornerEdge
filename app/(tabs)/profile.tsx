        ...
        <View style={[styles.container, { backgroundColor: colors.backgroundPrimary }]}>
            ...
            <ScrollView style={styles.content} contentContainerStyle={{ paddingBottom: insets.bottom + 100 }}>
                ...
                <View style={styles.section}>
                    <Text style={[styles.sectionTitle, { color: colors.textPrimary }]}>{t('profile.statistics') || 'Estatísticas'}</Text>
                    <View style={styles.statsGrid}>
                        ...
                        <View style={[styles.statCard, { backgroundColor: colors.backgroundSecondary }]}>
                            ...
                            <Text style={[styles.statLabel, { color: colors.textMuted }]}>{t('profile.accuracy') || 'V/D'}</Text>
                        </View>
                    </View>
                </View>
